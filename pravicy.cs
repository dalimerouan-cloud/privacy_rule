...
{
    // [AllowAnonymous] ensures this page is public even if you have
    // global auth middleware/filters applied to the rest of the app.
    [AllowAnonymous]
    [Route("privacy")]
...
<p>This Privacy Policy explains how <strong>[ sebsPro Order]</strong> (""we"", ""us"", ""our"") collects, uses,
...
<p>Your data is stored securely using <strong>[Cloud Provider]</strong>. We take reasonable
